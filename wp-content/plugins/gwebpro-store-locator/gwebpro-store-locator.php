  ...
  ?>
    <div class="location">
        <table border="0" id="location">
            <tr><td class="location_field"><label>Endereço:</label></td><td class="location_input"><input class="required" name="list-address1" value="<?php echo $address1; ?>" /></td></tr>
            <tr><td class="location_field"><label>Cidade, Estado, País:</label></td><td class="location_input"><input name="list-city" class="required" value="<?php echo $city; ?>" /></td></tr>
            <tr><td class="location_field"><label>CEP:</label></td><td class="location_input"><input name="list-postcode" class="required" value="<?php echo $post_code; ?>" /></td></tr>
            ...
            <tr><td class="location_field"><label>Latitude:</label></td><td class="location_input"><input name="list-lat" class="required" value="<?php echo $lat; ?>" /></td></tr>
            <tr><td class="location_field"><label>Longitude:</label></td><td class="location_input"><input name="list-long" class="required" value="<?php echo $long; ?>" /></td></tr>
        </table>
        <?php if($lat!="" && $long!=""){ ?>
  ...
  function meta_additional() {
	...
	<div class="additional">
        <table border="0" id="additional">
            ...
            <tr><td class="additional_field"><label>Site:</label></td><td class="additional_input"><input name="addi-website" value="<?php echo $website; ?>" size="40"/></td></tr>
            <tr><td class="additional_field"><label>Fone:</label></td><td class="additional_input"><input name="addi-phone" value="<?php echo $phone; ?>" /></td></tr>
            <tr><td class="additional_field"><label>Celular:</label></td><td class="additional_input"><input name="addi-mobile" value="<?php echo $mobile; ?>" /></td></tr>
	...
	function storeLists()
	{
		...
		<?php
			if(sizeof($result1)>0)
			{
				...
				<li>
					<div class="list_box general" onclick="launchInfoWindow(<?php echo $i?>);">
                        ...
                        <div class="left">
							...
							<?php if(get_option('distance_unit')=="Km") echo round($this->distance($lat, $long, $lat_p, $long_p, "K"),2) . " Km"; else echo round($this->distance($lat, $long, $lat_p, $long_p, ""),2) . " Miles";?> (Aprox.)
                            </p>
                            <div class="store_content"><?php echo get_the_content(); ?></div>
                            <p><strong>Endereço:</strong> <?php echo $address1?></p>
							...
							if(is_array($terms)){
								?>
								<p><strong>Linhas de produto:</strong>
								<?php
								$j=1;
                        ...
                        <div class="right">
                            <p><strong>Fone:</strong> <?php echo $phone?></p>
                            <p><strong>Site: </strong><a href="<?php echo $website?>" <?php if($website!="#"){?>target="_blank"<?php }?>><?php echo $website?></a></p>
                            <?php if($email!=""){?><p><strong>E-mail: </strong><a href="mailto:<?php echo $email?>"><?php echo $email?></a></p><?php }?>
                            <!--<p><strong>Celular:</strong> <?php echo $mobile?></p>
			   ...
			   latlong.push(new Array('<?php echo $lat_p?>','<?php echo $long_p?>','<?php echo get_the_title()?>','<?php if($url_small!=""){?><div class="store_thumb"><?php echo $url_small?></div><?php }?><div class="store_wrap" <?php if($url_small==""){?>style="width:auto;"<?php }?>><h3><?php echo get_the_title()?></h3><p><?php echo $address1?>,<?php echo $city?><br/>CEP: <?php echo $post_code?></p><p><a href="javascript:;" onclick="direction(\'<?php echo $address1?>,<?php echo $city?>\');">Como chegar</a></p></div><div class="clear"></div>'));
			   </script>
			<?php $i++;
        ...
        <?php
		 if($i==0){?>
            <div class="no-result">Nenhuma autorizada encontrada perto de você. <br>Por favor, refaça a sua pesquisa ou ligue para <b>(48) 3341-8600 / (48) 3333-1002 / (48) 9104-6791 - WhatsApp</b> para maiores informações.</div>
        <?php }
	}
