    ...
    class YITH_Product_Slider_Type
    {
        ...
        public function register_product_slider_post_type()
        {
            $args = apply_filters( 'yith_wcps_post_type', array(
                    ...
                    'description' => __('Yith WooCommerce Product Slider Carousel', 'ywcps'),
       ...
       update_post_meta( $slider_free_id, '_ywcps_free_slider_id', $slider_free_id );
        ...
        protected  function get_tab_taxonomy_label( $arg = '' ) {
            ...
            $label = apply_filters( 'yith_product_slider_taxonomy_label', array(
                    'name'                  =>  _x('YITH WooCommerce Product Slider Carousel', 'Post Type General Name', 'ywcps'),
                    'singular_name'         =>  _x('Product Slider Carousel', 'Post Type Singular Name', 'ywcps'),
                    'menu_name'             =>  __('Product Slider Carousel', 'ywcps'),
                    'parent_item_colon'     =>  __('Parent Item:', 'ywcps'),
                    'all_items'             =>  __('All Product Slider Carousels', 'ywcps'),
                    'view_item'             =>  __('View Product Slider Carousel', 'ywcps'),
                    'add_new_item'          =>  __('Add New Product Slider Carousel', 'ywcps'),
                    'add_new'               =>  __('Add New Product Slider Carousel', 'ywcps'),
                    'edit_item'             =>  __('Edit Product Slider Carousel', 'ywcps'),
                    'update_item'           =>  __('Update Product Slider Carousel', 'ywcps'),
                    'search_items'          =>  __('Search Product Slider Carousel', 'ywcps'),
                    'not_found'             =>  __('Not found', 'ywcps'),
                    'not_found_in_trash'    =>  __('Not found in Trash', 'ywcps'),
                )
            );
