...
function yith_ywcps_premium_install_woocommerce_admin_notice() {
        ?>
        <div class="error">
            <p><?php _e( 'YITH WooCommerce Product Slider Carousel Premium is enabled but not effective. It requires WooCommerce in order to work.', 'ywcps' ); ?></p>
        </div>
    <?php
    }
