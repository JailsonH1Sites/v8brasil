...
'layout3_settings'                       => array(
    ...
    'name'    => __( 'Background color navigation arrow', 'ywcps' ),
    'type'    => 'color',
    'desc'    => '',
    ...
    'name'    => __( 'Border color navigation arrow', 'ywcps' ),
    'type'    => 'color',
    'desc'    => '',
    ...
    'name'  =>  __( 'Text color navigation arrow', 'ywcps' ),
    'type'  =>  'color',
    'desc'  =>  '',
