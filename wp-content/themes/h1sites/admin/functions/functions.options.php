...
$of_options[] = array( 	"name" 		=> "Pagina inicial",
						"type" 		=> "heading"
				);
...
$of_options[] = array( 	"name" 		=> "Barra superior de pesquisa",
						"desc" 		=> "Selecione para aparecer a barra.",
...
$of_options[] = array( 	"name" 		=> "Logotipo",
						"desc" 		=> "Selecione a imagem que aparecerá no topo do site.",
						"id" 		=> "media_upload_35",
...
$of_options[] = array( 	"name" 		=> "Cores do site",
						"type" 		=> "heading"
				);
				
$of_options[] = array( 	"name" 		=> "Cor Padrão",
						"desc" 		=> "Cor Padrão do Tema (default: #fff).",
						"id" 		=> "body_background",
						"std" 		=> "",
						"type" 		=> "color"
				);
				
$of_options[] = array( 	"name" 		=> "Cor de Fundo",
						"desc" 		=> "Cor de fundo do seu site (default: #fff).",
						"id" 		=> "header_background",
						"std" 		=> "",
						"type" 		=> "color"
				);
				
$of_options[] = array( 	"name" 		=> "Cor de fundo Rodapé",
						"desc" 		=> "Selecione a cor de fundo do rodapé (default: #fff).",
